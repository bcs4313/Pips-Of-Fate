...
export default function GameDataDisplay() {
    ...
    function generateRadiationIcon() {
        return <div className="w-[15%] flex flex-column bottom-[63%] left-[5%] z-50 hover:cursor-pointer">
    ...
    {
        statComponents.push(<div key="frostQuantityIndicator" className="ml-[5px] flex flex-row bottom-[130px] w-[20vw] text-start">
        {generateFrostIcon()}
    ...
    if(engine.engineState["radiationStacks"] && engine.engineState["radiationStacks"] > 0)
    {
        ...
        statComponents.push(<div key="radiationStackIndicator" className="ml-[5px] flex flex-row bottom-[130px] w-[20vw] text-start">
